            ...
            <table id="inputdata">
                ...
                <tr>
                    <form action="" method="POST" enctype="multipart/form-data" id="input">
                        ...
                        <td colspan="2"> 
                            <button type="submit" name="submit" class="btn btn-primary" form="input"> Simpan </button> 
                        </td>
                    </form>
                </tr>
            </table>
                ...
                <tbody>
                    ...
                    foreach ($arrayData as $data) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="lihat.php?id_jual=<?php echo $data->id_jual; ?>&state=delete" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    <?php
                    }
